...
public class ProcessBurstList {
    ...
    public void generateControlledBursts(int cpucycles1, int iocycles, int cpucycles2) {

        ProcessBurst temp = new ProcessBurst(cpucycles1, ProcessBurstType.CPU);
        addBurst(temp);
        temp = new ProcessBurst(iocycles, ProcessBurstType.IO);
        addBurst(temp);
        temp = new ProcessBurst(cpucycles2, ProcessBurstType.CPU);
        addBurst(temp);
